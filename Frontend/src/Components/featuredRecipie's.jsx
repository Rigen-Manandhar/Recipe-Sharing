    ...
    <>
      <div className="flex flex-col p-5 mt-10">
        ...
        <div className="relative w-full flex justify-center items-center">
          ...
          <button className="absolute left-65 text-3xl text-white bg-gray-700 opacity-80 w-10 h-16 rounded-xl cursor-pointer">
            ‹
          </button>

          <button className="absolute right-65 text-3xl text-white bg-gray-700 opacity-80 w-10 h-16 rounded-xl cursor-pointer">
            ›
          </button>
        </div>
      </div>
